...
import 'package:siddikbhai_c/Sobdosomuh/option_ones.dart';
...
class SobdoSingle extends StatefulWidget {

  String? id;
  String? name;

  SobdoSingle(this.id,this.name,);

  @override
  State<SobdoSingle> createState() => _SobdoSingleState();
}

class _SobdoSingleState extends State<SobdoSingle> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
        ...
        onTap: (){
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => OptionOnes(widget.id)),
          );
        },
        child:
        Container(
