...
class _GalleryOptionState extends State<GalleryOption> {
  ...
  Future<void> _getAllItems() async {
    allItems = await RemoteService().getGallery();
    list.clear();
    setState(() {
      ...
      for (int i = 0; i < allItems!.length; i++) {
        ...
        list.add(Gallery_Single(allItems![i].id,allItems![i].name,allItems![i].image));
      }
      isLoaded = true;
    });
  }
